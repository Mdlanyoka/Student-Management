...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ADD NEW STUDENTS ");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 500, 230, 50));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 0, -1, -1));
        ...
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 240, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("STUDENT I.D");
        ...
        jPanel1.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 240, 30));
        ...
        jPanel1.add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 370, 240, 30));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("STUDENT GRADE");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, -1, -1));

        jTextField9.setBackground(new java.awt.Color(51, 0, 0));
        ...
        jPanel1.add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, 240, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setText("STUDENT MAJOR");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, -1, -1));

        jTextField10.setBackground(new java.awt.Color(51, 0, 0));
        ...
        jPanel1.add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 240, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 160, 360, 320));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int grade = Integer.parseInt(jTextField8.getText());
        String major = jTextField9.getText();
        
        CollegeStudent studentManagementSystem = new CollegeStudent(id, name, age, grade, major);
        
        // Check if the student ID already exists
        if (studentManagementSystem.isStudentIDExists(id)) {
            JOptionPane.showMessageDialog(null, "A student with the same ID already exists. Please select a different ID.", "Duplicate ID", JOptionPane.ERROR_MESSAGE);
        } else {
            studentManagementSystem.add(id, name, age, grade);
        ...
        JOptionPane.showMessageDialog(null, "Invalid input for ID, age, or grade.", "Input Error", JOptionPane.ERROR_MESSAGE);
    }
